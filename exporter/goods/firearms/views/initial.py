...
from exporter.core.helpers import (
    ...
    has_organisation_firearm_act_document as _has_firearm_act_document,
)
...
def get_attach_certificate_initial_data(document_type, organisation, good):
    if not _has_firearm_act_document(organisation, document_type):
        return {}

    document = get_organisation_firearm_act_document(organisation, document_type)
