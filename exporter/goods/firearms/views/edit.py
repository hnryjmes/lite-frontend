...
from .mixins import GoodMixin, Product2FlagMixin, OrganisationMixin
...
class BaseEditView(
    ...
    def get_success_url(self):
        return reverse("goods:good", kwargs=self.kwargs)
    ...
    def get_context_data(self, **kwargs):
        ...
        ctx["back_link_url"] = reverse("goods:good", kwargs=self.kwargs)
...
class FirearmEditRegisteredFirearmsDealer(BaseEditWizardView):
    ...
    def get_attach_rfd_certificate_initial_data(self):
        rfd_certificate = get_organisation_rfd_certificate(self.organisation)
    ...
    def get_form_initial(self, step):
        ...
        if step == AddGoodFirearmSteps.IS_REGISTERED_FIREARMS_DEALER:
            initial["is_registered_firearm_dealer"] = has_valid_organisation_rfd_certificate(self.organisation)
