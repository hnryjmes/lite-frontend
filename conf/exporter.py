...
FEATURE_FLAG_GOVUK_SIGNIN_ENABLED = env.bool("FEATURE_FLAG_GOVUK_SIGNIN_ENABLED", True)
...
# Non Firearms feature flags
FEATURE_FLAG_NON_FIREARMS_COMPONENT_ENABLED = env.bool("FEATURE_FLAG_NON_FIREARMS_COMPONENT_ENABLED", True)
FEATURE_FLAG_NON_FIREARMS_SOFTWARE_ENABLED = env.bool("FEATURE_FLAG_NON_FIREARMS_SOFTWARE_ENABLED", True)
FEATURE_FLAG_NON_FIREARMS_MATERIAL_ENABLED = env.bool("FEATURE_FLAG_NON_FIREARMS_MATERIAL_ENABLED", True)
FEATURE_FLAG_NON_FIREARMS_PLATFORM_ENABLED = env.bool("FEATURE_FLAG_NON_FIREARMS_PLATFORM_ENABLED", True)

# Enable Security classified questions
FEATURE_FLAG_F680_SECURITY_CLASSIFIED_ENABLED = env.bool("FEATURE_FLAG_F680_SECURITY_CLASSIFIED_ENABLED", True)

if any(
    [
        FEATURE_FLAG_NON_FIREARMS_COMPONENT_ENABLED,
        FEATURE_FLAG_NON_FIREARMS_SOFTWARE_ENABLED,
        FEATURE_FLAG_NON_FIREARMS_MATERIAL_ENABLED,
        FEATURE_FLAG_NON_FIREARMS_PLATFORM_ENABLED,
    ]
):
